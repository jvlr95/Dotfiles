...
" -----------------------------------------------------------------------------
" Configuração para JavaScript/React
" Use o pacote `node-inspect` para depuração
let g:dap_nodejs_debugger='node'
let g:dap_nodejs_debug_args='--inspect-brk'
" Configuração para Python
" Use o pdb para depuração
let g:dap_python_debugger='python -m pdb'
" Ativar o DAP
let g:dap_enabled = 1
" Definir pontos de interrupção
autocmd FileType javascript nnoremap <buffer> <F9> call v:lua.require'dap'.toggle_breakpoint()
autocmd FileType python nnoremap <buffer> <F9> call v:lua.require'dap'.toggle_breakpoint()
